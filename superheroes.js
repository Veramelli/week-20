let heroesArray = `[{
    ...
    },
    {
        ...
        "name": "Чудо-женщина",
        "skills": "сверхчеловеческая сила искорость, выносливость, полет",
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    for (let hero of heroes) {
        ...
        <div class='rating_text'>Рейтинг супергероя</div>
        <div class='rating'><input class="${hero.class}" type='number' onmouseleave ="${hero.function}()"></div>
        </div>
        </div>`;
    }
